...
# Revision 1.1  1995/08/15  14:36:46  pk
...
IMPORT Text, Word, M3toC, Ustat, Unix, Ctypes;
...
PROCEDURE Stat (READONLY name: ARRAY OF CHAR; VAR buf: FStatType):
  ...
  BEGIN
    ...
    buf := FStatType{
             UnixStat.st_dev, UnixStat.st_ino,
             ModeToPermSet(UnixStat.st_mode), UnixStat.st_nlink,
             UnixStat.st_uid, UnixStat.st_gid, UnixStat.st_rdev,
             UnixStat.st_size, UnixStat.st_atime, UnixStat.st_spare1,
             UnixStat.st_mtime, UnixStat.st_spare2, UnixStat.st_ctime,
             UnixStat.st_spare3, UnixStat.st_blksize, UnixStat.st_blocks,
             ARRAY [0 .. 1] OF
               Ctypes.long{UnixStat.st_spare41, UnixStat.st_spare42},
             ModeToSFT(UnixStat.st_mode)};
