...
INTERFACE  Rules;
  ...
  TYPE
    ...
    UnaryOperation = [Operation.Plus..Operation.Star];
    BracketOperation = [Operation.Optional..Operation.Bracket];
    BinaryOperation = [Operation.Sequence..Operation.Alternative];
    ArtificialOperation = [Operation.ArtAlternative..Operation.ArtAlternative];
    LeafOperation = [Operation.TermLeaf..Operation.NonTermLeaf];
    Expression <: ADDRESS;		(* eine rechte Seite *)
    MRules <: ADDRESS;		(* Regeln *)
