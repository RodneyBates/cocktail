...
BEGIN
   f := ReadOpen (ARRAY [0..8] OF CHAR{'M','a','k','e','f','i','l','e','\000'});
   g := WriteOpen ('t');
   ...
   WriteS (StdOutput, ARRAY [0..28] OF CHAR{'e','n','t','e','r',' ','i','n','t','e','g','e','r','s',',',' ','9','9',' ','w','i','l','l',' ','s','t','o','p','\000'});
   WriteNl (StdOutput);
   REPEAT
   ...
   WriteS (StdOutput, ARRAY [0..25] OF CHAR{'e','n','t','e','r',' ','r','e','a','l','s',',',' ','9','9',' ','w','i','l','l',' ','s','t','o','p','\000'});
   WriteNl (StdOutput);
   REPEAT
      WriteFlush (StdOutput);
      r := ReadR (StdInput);
