...
; PROCEDURE CheckSetSet 
    ( VAR Set1 , Set2 : tSet ; READONLY Name : ARRAY OF CHAR ) 
  ...
  = BEGIN (* CheckSetSet *) 
    ...
    ; IF Set1 . MaxElmt # Set2 . MaxElmt 
      THEN 
        WriteS 
          ( StdError 
          , ARRAY [ 0 .. 5 ] OF CHAR { 'S' , 'e' , 't' , 's' , '.' , '\000' } 
          ) 
      ; WriteS ( StdError , Name ) 
      ; WriteS 
          ( StdError 
          , ARRAY [ 0 .. 19 ] OF CHAR 
              { ':' , ' ' , 'i' , 'n' , 'c' , 'o' , 'm' , 'p' , 'a' , 't' 
...
; PROCEDURE CheckSetElmt 
    ( VAR Set : tSet ; Elmt : INTEGER ; READONLY Name : ARRAY OF CHAR ) 
...
; PROCEDURE Union ( VAR Set1 : tSet ; Set2 : tSet ) 
  ...
  = BEGIN (* Union *) 
      CheckSetSet 
        ( Set1 
        , Set2 
        , ARRAY [ 0 .. 5 ] OF CHAR { 'U' , 'n' , 'i' , 'o' , 'n' , '\000' } 
        ) 
...
; PROCEDURE Card ( VAR Set : tSet ) : Word . T 
  ...
  = BEGIN (* Card *) 
      CheckSet 
        ( Set , ARRAY [ 0 .. 4 ] OF CHAR { 'C' , 'a' , 'r' , 'd' , '\000' } ) 
...
; PROCEDURE Size ( VAR Set : tSet ) : Word . T 
  ...
  = BEGIN (* Size *) 
      CheckSet 
        ( Set , ARRAY [ 0 .. 4 ] OF CHAR { 'S' , 'i' , 'z' , 'e' , '\000' } ) 
