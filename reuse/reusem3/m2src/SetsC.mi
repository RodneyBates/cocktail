...
PROCEDURE CheckSetElmt (VAR Set: tSet; Elmt: INTEGER; Name: ARRAY OF CHAR);
   BEGIN
	 ...
	 PrintSet (Set);
      END;
      IF Elmt > VAL ( INTEGER , Set.MaxElmt ) THEN
	 WriteS (StdError, "Sets."); WriteS (StdError, Name); 
...
PROCEDURE PrintSet (Set: tSet);
   BEGIN
      WITH Set DO
        WriteS (StdError, "BitsetPtr = "); 
        WriteN (StdError, LONGCARD(BitsetPtr), 0, 16); WriteNl (StdError);
        WriteS (StdError, "MaxElmt   = "); 
        WriteI (StdError, VAL ( INTEGER , MaxElmt ) , 0); WriteNl (StdError);
        WriteS (StdError, "LastBitset= "); 
        WriteI (StdError, VAL ( INTEGER , LastBitset ) , 0); WriteNl (StdError);
        WriteS (StdError, "Card      = "); 
        WriteI (StdError, VAL ( INTEGER , Card ) , 0); WriteNl (StdError);
        WriteS (StdError, "FirstElmt = "); 
        WriteI (StdError, VAL ( INTEGER , FirstElmt ) , 0); WriteNl (StdError);
        WriteS (StdError, "LastElmt  = "); 
        WriteI (StdError, VAL ( INTEGER , LastElmt ) , 0); WriteNl (StdError);
      END;
   END PrintSet;
