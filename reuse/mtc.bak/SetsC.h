...
typedef Sets_ProcOftElement SetsC_ProcOftElement;
typedef Sets_ProcOftElementToBool SetsC_ProcOftElementToBool;
typedef Sets_tSet SetsC_tSet;
extern void SetsC_InitNullSet ARGS((SetsC_tSet *Set));
...
extern BOOLEAN SetsC_Forall ARGS((SetsC_tSet Set, SetsC_ProcOftElementToBool Proc));
extern BOOLEAN SetsC_Exists ARGS((SetsC_tSet Set, SetsC_ProcOftElementToBool Proc));
extern BOOLEAN SetsC_Exists1 ARGS((SetsC_tSet Set, SetsC_ProcOftElementToBool Proc));
