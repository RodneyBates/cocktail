...
(* line 201 "../src/rex.cg" *) 
      ; yyt ^ . Node1 . NodeCount 
          := yyt ^ . Node1 . Son1 ^ . Node . NodeCount 
(* line 177 "../src/rex.cg" *) 
      ; yyt ^ . Node1 . LeafCount 
          := yyt ^ . Node1 . Son1 ^ . Node . LeafCount 
(* line 159 "../src/rex.cg" *) 
...
(* line 201 "../src/rex.cg" *) 
      ; yyt ^ . Option . NodeCount 
          := yyt ^ . Option . Son1 ^ . Node . NodeCount 
(* line 177 "../src/rex.cg" *) 
      ; yyt ^ . Option . LeafCount 
          := yyt ^ . Option . Son1 ^ . Node . LeafCount 
(* line 160 "../src/rex.cg" *) 
      ; yyt ^ . Option . IsConstantRE := FALSE 
(* line 91 "../src/rex.cg" *) 
      ; yyt ^ . Option . Tree 
          := MakeTree1 ( nOption , yyt ^ . Option . Son1 ^ . Node . Tree ) 
      | Tree0 . Repetition 
      => yyVisit1 ( yyt ^ . Repetition . Son1 ) 
(* line 201 "../src/rex.cg" *) 
      ; yyt ^ . Repetition . NodeCount 
          := yyt ^ . Repetition . Son1 ^ . Node . NodeCount 
(* line 177 "../src/rex.cg" *) 
      ; yyt ^ . Repetition . LeafCount 
          := yyt ^ . Repetition . Son1 ^ . Node . LeafCount 
(* line 161 "../src/rex.cg" *) 
      ; yyt ^ . Repetition . IsConstantRE := FALSE 
(* line 92 "../src/rex.cg" *) 
      ; yyt ^ . Repetition . Tree 
          := MakeTree1 
               ( nRepetition , yyt ^ . Repetition . Son1 ^ . Node . Tree ) 
      | Tree0 . Node2 
      => yyVisit1 ( yyt ^ . Node2 . Son2 ) 
      ; yyVisit1 ( yyt ^ . Node2 . Son1 ) 
(* line 202 "../src/rex.cg" *) 
      ; yyt ^ . Node2 . NodeCount 
          := yyt ^ . Node2 . Son1 ^ . Node . NodeCount 
             + yyt ^ . Node2 . Son2 ^ . Node . NodeCount 
(* line 178 "../src/rex.cg" *) 
      ; yyt ^ . Node2 . LeafCount 
          := yyt ^ . Node2 . Son1 ^ . Node . LeafCount 
             + yyt ^ . Node2 . Son2 ^ . Node . LeafCount 
(* line 159 "../src/rex.cg" *) 
...
(* line 202 "../src/rex.cg" *) 
      ; yyt ^ . List . NodeCount 
          := yyt ^ . List . Son1 ^ . Node . NodeCount 
             + yyt ^ . List . Son2 ^ . Node . NodeCount 
(* line 178 "../src/rex.cg" *) 
      ; yyt ^ . List . LeafCount 
          := yyt ^ . List . Son1 ^ . Node . LeafCount 
             + yyt ^ . List . Son2 ^ . Node . LeafCount 
(* line 159 "../src/rex.cg" *) 
...
(* line 93 "../src/rex.cg" *) 
      ; yyt ^ . List . Tree 
          := MakeTree2 
               ( nList 
               , yyt ^ . List . Son1 ^ . Node . Tree 
               , yyt ^ . List . Son2 ^ . Node . Tree 
               ) 
      | Tree0 . Sequence 
      => yyVisit1 ( yyt ^ . Sequence . Son2 ) 
      ; yyVisit1 ( yyt ^ . Sequence . Son1 ) 
(* line 202 "../src/rex.cg" *) 
      ; yyt ^ . Sequence . NodeCount 
          := yyt ^ . Sequence . Son1 ^ . Node . NodeCount 
             + yyt ^ . Sequence . Son2 ^ . Node . NodeCount 
(* line 178 "../src/rex.cg" *) 
      ; yyt ^ . Sequence . LeafCount 
          := yyt ^ . Sequence . Son1 ^ . Node . LeafCount 
             + yyt ^ . Sequence . Son2 ^ . Node . LeafCount 
(* line 162 "../src/rex.cg" *) 
      ; yyt ^ . Sequence . IsConstantRE 
          := yyt ^ . Sequence . Son1 ^ . Node . IsConstantRE 
             AND yyt ^ . Sequence . Son2 ^ . Node . IsConstantRE 
(* line 94 "../src/rex.cg" *) 
      ; yyt ^ . Sequence . Tree 
          := MakeTree2 
               ( nSequence 
               , yyt ^ . Sequence . Son1 ^ . Node . Tree 
               , yyt ^ . Sequence . Son2 ^ . Node . Tree 
               ) 
      | Tree0 . Alternative 
      => yyVisit1 ( yyt ^ . Alternative . Son2 ) 
      ; yyVisit1 ( yyt ^ . Alternative . Son1 ) 
(* line 202 "../src/rex.cg" *) 
      ; yyt ^ . Alternative . NodeCount 
          := yyt ^ . Alternative . Son1 ^ . Node . NodeCount 
             + yyt ^ . Alternative . Son2 ^ . Node . NodeCount 
(* line 178 "../src/rex.cg" *) 
      ; yyt ^ . Alternative . LeafCount 
          := yyt ^ . Alternative . Son1 ^ . Node . LeafCount 
             + yyt ^ . Alternative . Son2 ^ . Node . LeafCount 
(* line 163 "../src/rex.cg" *) 
      ; yyt ^ . Alternative . IsConstantRE := FALSE 
(* line 95 "../src/rex.cg" *) 
      ; yyt ^ . Alternative . Tree 
          := MakeTree2 
               ( nAlternative 
               , yyt ^ . Alternative . Son1 ^ . Node . Tree 
               , yyt ^ . Alternative . Son2 ^ . Node . Tree 
               ) 
      | Tree0 . Ch 
      => 
(* line 203 "../src/rex.cg" *) 
...
(* line 165 "../src/rex.cg" *) 
      ...
      => 
(* line 205 "../src/rex.cg" *) 
         yyt ^ . String . NodeCount 
           := StringMem . Length ( yyt ^ . String . String ) 
(* line 181 "../src/rex.cg" *) 
      ; yyt ^ . String . LeafCount 
          := StringMem . Length ( yyt ^ . String . String ) 
(* line 166 "../src/rex.cg" *) 
...
(* line 206 "../src/rex.cg" *) 
      ; yyt ^ . Rule . NodeCount 
          := yyt ^ . Rule . Patterns ^ . Node . NodeCount 
(* line 182 "../src/rex.cg" *) 
      ; yyt ^ . Rule . LeafCount 
          := yyt ^ . Rule . Patterns ^ . Node . LeafCount 
(* line 159 "../src/rex.cg" *) 
...
(* line 207 "../src/rex.cg" *) 
      ...
      ; IF yyt ^ . Pattern . RegExpr ^ . Node . IsConstantRE 
           AND yyt ^ . Pattern . RightContext ^ . Node . IsConstantRE 
        THEN 
          yyt ^ . Pattern . card := Card ( yyt ^ . Pattern . StartStates ) 
        ; yyt ^ . Pattern . NodeCount 
            := ( yyt ^ . Pattern . RegExpr ^ . Node . NodeCount 
                 + yyt ^ . Pattern . RightContext ^ . Node . NodeCount 
               ) 
               * yyt ^ . Pattern . card 
        ELSE 
...
(* line 183 "../src/rex.cg" *) 
      ...
      ; IF NOT ( yyt ^ . Pattern . RegExpr ^ . Node . IsConstantRE 
                 AND yyt ^ . Pattern . RightContext ^ . Node . IsConstantRE 
               ) 
        THEN 
          yyt ^ . Pattern . LeafCount 
            := yyt ^ . Pattern . RegExpr ^ . Node . LeafCount 
               + yyt ^ . Pattern . RightContext ^ . Node . LeafCount 
        ELSE 
...
(* line 148 "../src/rex.cg" *) 
      ; yyt ^ . Pattern . Tree 
          := MakeTreePattern 
               ...
               , yyt ^ . Pattern . RegExpr ^ . Node . Tree 
               , yyt ^ . Pattern . RightContext ^ . Node . Tree 
               , yyt ^ . Pattern . RegExpr ^ . Node . IsConstantRE 
                 AND yyt ^ . Pattern . RightContext ^ . Node . IsConstantRE 
