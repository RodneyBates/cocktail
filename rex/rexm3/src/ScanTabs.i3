...
; TYPE TableElmt = SHORTCARD 
  ; StateRange = TableElmt 
  ; RuleRange = TableElmt 
  ; RuleType = TableElmt 
  ; TableRange = Word . T 
  ; ActionType = TableElmt 
  ; ControlType = RECORD Check , Next : TableElmt END (* RECORD *) 

; TYPE RuleBase = ARRAY [ 0 .. 100000 ] OF RuleRange 
...
; VAR RuleBasePtr : UNTRACED BRANDED REF RuleBase 
