(* $Id: Traces.md,v 3.1 1991/11/21 14:41:19 grosch rel $ *) 
...
; PROCEDURE RecordTrace 
    ( Position : SHORTCARD ; TraceState , NewState : DStateRange ) 

; PROCEDURE RecordedTrace 
    ( Position : SHORTCARD ; TraceState : DStateRange ) : DStateRange 
