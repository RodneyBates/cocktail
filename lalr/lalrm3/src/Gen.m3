...
UNSAFE MODULE Gen;
  ...
  PROCEDURE GenCommandLineComment ( out : tFile ) = 
    BEGIN
      WriteNl (out);
      WriteT (out, "(* This file was generated by metaprogram lalr," );
      WriteNl (out);
      WriteT (out, "   with command line (excluding surrounding quotes):" );
      WriteNl (out);
      WriteT (out, "   \"" );
      WriteT (out, ArgCheck . ArgListAsText ( ) );
      WriteT (out, "\"" );
      WriteNl (out);
      WriteT (out, "*)" );
      WriteNl (out);
      WriteNl (out);
    END GenCommandLineComment;
