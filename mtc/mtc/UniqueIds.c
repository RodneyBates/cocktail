...
# endif
{
  ...
  case UniqueIds_eField:;
    return Sets_IsElement((Sets_tElement)Ident, &PervasiveIds);
    break;
  case UniqueIds_eConst:;
  case UniqueIds_eType:;
    return Sets_IsElement((Sets_tElement)Ident, &ModulaIds);
    break;
  case UniqueIds_eProc:;
    return Sets_IsElement((Sets_tElement)Ident, &PervasiveIds) || Sets_IsElement((Sets_tElement)Ident, &IdStack->A[0]);
    break;
  case UniqueIds_eVar:;
    return Sets_IsElement((Sets_tElement)Ident, &PervasiveIds) || Sets_IsElement((Sets_tElement)Ident, &IdStack->A[StackPtr]);
    break;
  case UniqueIds_eModuleVar:;
    return Sets_IsElement((Sets_tElement)Ident, &PervasiveIds) || Sets_IsElement((Sets_tElement)Ident, &IdStack->A[StackPtr]) || Sets_IsElement((Sets_tElement)Ident, &IdStack->A[0]);
    break;
...
# endif
{
  ...
  Sets_Include(&ModulaIds, (Sets_tElement)Ident);
  switch (IdentClass) {
  case UniqueIds_eKeyword:;
  case UniqueIds_eConst:;
  case UniqueIds_eType:;
    Sets_Include(&PervasiveIds, (Sets_tElement)Ident);
    break;
  case UniqueIds_eProc:;
    Sets_Include(&IdStack->A[0], (Sets_tElement)Ident);
    break;
  case UniqueIds_eVar:;
    Sets_Include(&IdStack->A[StackPtr], (Sets_tElement)Ident);
    break;
  case UniqueIds_eModuleVar:;
    Sets_Include(&IdStack->A[StackPtr], (Sets_tElement)Ident);
    Sets_Include(&IdStack->A[0], (Sets_tElement)Ident);
