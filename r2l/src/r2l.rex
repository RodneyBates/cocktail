/* $Id: rex.rex,v 3.2 1991/11/21 14:42:27 grosch Exp grosch $ */
...
(* Changes: 
   Rodney M. Bates: 
     July, 1999 Fixed failure to compute position of comment.
*) 
...
#targetcode#	'	: { GetWord (String); yyStart (CStr1); }

#targetcode#	\"	: { GetWord (String); yyStart (CStr2); }
